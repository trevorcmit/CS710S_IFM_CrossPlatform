...
{
    public class ViewModelMultiBankInventory : BaseViewModel
	{
        ...
        public ViewModelMultiBankInventory(IAdapter adapter, IUserDialogs userDialogs) : base(adapter)
        {
